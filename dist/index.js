...
class HandDrawnBase extends h$1 {
  ...
  set roughOps(value) {
    ...
    this.roughOpsOrigin = __spreadValues$4(__spreadValues$4({}, this.roughOpsDefault), value);
...
HandDrawnButton = __decorateClass$b([
...
let HandDrawnIcon = class extends HandDrawnBase {
  ...
  iconCross(roughObj) {
    ...
    const arcObj = {
      ...
      x4: size.width / 10 * 9,
      y4: size.height / 10,
      roughOps: __spreadProps$3(__spreadValues$3({}, this.roughOps), {
...
HandDrawnIcon = __decorateClass$a([
  n$1("hand-drawn-icon")
], HandDrawnIcon);
...
HandDrawnPad = __decorateClass$9([
  n$1("hand-drawn-pad")
], HandDrawnPad);
...
HandDrawnInput = __decorateClass$8([
...
HandDrawnTextarea = __decorateClass$7([
...
HandDrawnCheckbox = __decorateClass$6([
...
HandDrawnCheckboxGroup = __decorateClass$5([
...
let HandDrawnRadio = class extends HandDrawnBase {
  ...
  roughDrawOne(roughObj) {
    ...
    if (roughObj.roughParentEl.id === "dot") {
      ...
      const nodeArray = [];
      nodeArray.push(roughObj.roughInstance.circle(size.width / 2, size.height / 2, (size.width - this.roughPadding) / 2, __spreadProps$2(__spreadValues$2(__spreadValues$2({}, this.roughOps), {
      ...
      const nodeArray = [];
      nodeArray.push(roughObj.roughInstance.circle(size.width / 2, size.height / 2, size.width - this.roughPadding, __spreadValues$2(__spreadValues$2({}, this.roughOps), {
        roughness: (this.roughOps.roughness || 0) * 2 / 3,
        bowing: (this.roughOps.bowing || 0) * 2 / 3
      })));
      if (roughObj.roughEl instanceof SVGSVGElement) {
...
HandDrawnRadio = __decorateClass$4([
...
HandDrawnRadioGroup = __decorateClass$3([
...
HandDrawnDialog = __decorateClass$2([
...
let HandDrawnSwitch = class extends HandDrawnBase {
  ...
  roughDrawOne(roughObj) {
    ...
    if (roughObj.roughParentEl.id === "switchWrapper") {
      ...
      const nodeArray = [];
      nodeArray.push(roughObj.roughInstance.rectangle(this.roughPadding, this.roughPadding, size.width - this.roughPadding * 2, size.height - this.roughPadding * 2, __spreadProps$1(__spreadValues$1({ fill: this.checked ? this.rightBgFill : this.leftBgFill }, this.roughOps), { strokeWidth: 1, stroke: "transparent" })));
      nodeArray.push(roughObj.roughInstance.line(size.height / 5 * 2 + this.roughPadding, this.roughPadding, size.width - (size.height / 5 * 2 + this.roughPadding), this.roughPadding, __spreadProps$1(__spreadValues$1({}, this.roughOps), { strokeWidth: 1 })));
      nodeArray.push(roughObj.roughInstance.line(size.height / 5 * 2 + this.roughPadding, size.height - this.roughPadding, size.width - (size.height / 5 * 2 + this.roughPadding), size.height - this.roughPadding, __spreadProps$1(__spreadValues$1({}, this.roughOps), { strokeWidth: 1 })));
      nodeArray.push(roughObj.roughInstance.arc(size.height / 5 * 2 + this.roughPadding, size.height / 2, size.height / 5 * 4 - this.roughPadding * 2, size.height / 5 * 4, Math.PI / 2, Math.PI / 2 * 3, false, __spreadProps$1(__spreadValues$1({}, this.roughOps), { strokeWidth: 1 })));
      nodeArray.push(roughObj.roughInstance.arc(size.width - (size.height / 5 * 2 + this.roughPadding), size.height / 2, size.height / 5 * 4, size.height - this.roughPadding * 2, Math.PI / 2 * 3, Math.PI / 2 * 5, false, __spreadProps$1(__spreadValues$1({}, this.roughOps), { strokeWidth: 1 })));
      if (roughObj.roughEl instanceof SVGSVGElement) {
        roughObj.roughEl.innerHTML = "";
        for (let node of nodeArray) {
          roughObj.roughEl.appendChild(node);
      ...
      const nodeArray = [];
      nodeArray.push(roughObj.roughInstance.circle(size.height / 5 * 2 + this.roughPadding, size.height / 2, size.height - this.roughPadding * 2, __spreadValues$1({ fill: (this.checked ? this.rightToggleFill : this.leftToggleFill) || this.roughOps.stroke, fillStyle: "zigzag" }, this.roughOps)));
      if (roughObj.roughEl instanceof SVGSVGElement) {
        roughObj.roughEl.innerHTML = "";
        for (let node of nodeArray) {
          roughObj.roughEl.appendChild(node);
...
HandDrawnSwitch = __decorateClass$1([
...
let HandDrawnAnchor = class extends HandDrawnBase {
  ...
  roughDrawOne(roughObj) {
    ...
    const nodeArray = [];
    nodeArray.push(roughObj.roughInstance.line(0, size.height - this.roughPadding, size.width, size.height - this.roughPadding, __spreadProps(__spreadValues({}, this.roughOps), { stroke: this.lineColor || this.roughOps.stroke })));
    if (roughObj.roughEl instanceof SVGSVGElement) {
      roughObj.roughEl.innerHTML = "";
      for (let node of nodeArray) {
        roughObj.roughEl.appendChild(node);
...
HandDrawnAnchor = __decorateClass([
