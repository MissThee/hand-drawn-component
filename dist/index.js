...
class HandDrawnBase extends h$1 {
  ...
  set roughOps(value) {
    ...
    this.roughOpsOrigin = __spreadValues$3(__spreadValues$3({}, this.roughOpsDefault), value);
...
HandDrawnButton = __decorateClass$a([
...
let HandDrawnIcon = class extends HandDrawnBase {
  ...
  iconCross(roughObj) {
    ...
    const arcObj = {
      ...
      x4: size.width / 10 * 9,
      y4: size.height / 10,
      roughOps: __spreadProps$2(__spreadValues$2({}, this.roughOps), {
...
HandDrawnIcon = __decorateClass$9([
  n$1("hand-drawn-icon")
], HandDrawnIcon);
...
HandDrawnPad = __decorateClass$8([
  n$1("hand-drawn-pad")
], HandDrawnPad);
...
HandDrawnInput = __decorateClass$7([
...
HandDrawnTextarea = __decorateClass$6([
...
HandDrawnCheckbox = __decorateClass$5([
...
HandDrawnCheckboxGroup = __decorateClass$4([
...
let HandDrawnRadio = class extends HandDrawnBase {
  ...
  roughDrawOne(roughObj) {
    ...
    if (roughObj.roughParentEl.id === "dot") {
      ...
      const nodeArray = [];
      nodeArray.push(roughObj.roughInstance.circle(size.width / 2, size.height / 2, (size.width - this.roughPadding) / 2, __spreadProps$1(__spreadValues$1(__spreadValues$1({}, this.roughOps), {
      ...
      const nodeArray = [];
      nodeArray.push(roughObj.roughInstance.circle(size.width / 2, size.height / 2, size.width - this.roughPadding, __spreadValues$1(__spreadValues$1({}, this.roughOps), {
        roughness: (this.roughOps.roughness || 0) * 2 / 3,
        bowing: (this.roughOps.bowing || 0) * 2 / 3
      })));
      if (roughObj.roughEl instanceof SVGSVGElement) {
...
HandDrawnRadio = __decorateClass$3([
...
HandDrawnRadioGroup = __decorateClass$2([
...
HandDrawnDialog = __decorateClass$1([
...
HandDrawnSwitch = __decorateClass([
